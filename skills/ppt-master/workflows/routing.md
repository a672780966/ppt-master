...
| User asks AI to edit a selected object/element/slide on a `build_state.json`-adopted project, or a queued AI Edit job exists | Run [`ai-edit`](./stages/ai-edit.md) — discover the job, read its compiled context, reason, submit a structured EditPlan; never edit the SVG directly for this case |
